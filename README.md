...
The solution uses records (which is a C# type designed primarily for storing data where the values themselves are important) for Product commands (query get product, update, delete, and create product) along with their command handler.
